...
public sealed record OutputArtifactPayload
{
...
public sealed record WorkerPromptPackage
{
    public string PromptVersion { get; init; } = "worker-v1";
...
public sealed record TaskWorkerRequest
{
    public string ProviderId { get; init; } = "openai";
...
public sealed record TaskWorkerResult
{
    public string TaskId { get; init; } = string.Empty;
